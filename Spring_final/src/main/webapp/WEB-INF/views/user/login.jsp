			...
			<div class="Grid_row">
				<div class="index_container">
					...
					<div class="index_kakaoOauthButtonWrapper">
						<button type="button" class="button button_large button_fx" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=b11fa6774e0285e50b5a9dfa4047b19f&redirect_uri=http://localhost:8080/project/main.do&response_type=code'">
